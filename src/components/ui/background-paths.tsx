...
interface FloatingPathsProps {
  position: number
  /** Tailwind text-color class to tint the paths. Defaults to slate-950 (light bg) */
  colorClass?: string
}

export function FloatingPaths({ position, colorClass = 'text-slate-950' }: FloatingPathsProps) {
